...
Recall_tr = conf_mat_train[1,1]/(conf_mat_train[1,1]+conf_mat_train[1,2])
...
#Recall - 20% - The flight delays correctly recognized

#Specificity - 95% - Flights that are on time are recognized correctly

#Precision - 82% - flights that are delayed are indeed delayed

#LOW RECALL and HIGH PRECISION - Flights that are delayed are predicted incorrectly. However, flights that are delayed are indeed delayed
